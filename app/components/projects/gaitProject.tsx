...
export const gaitProject = (
  <div
    ...
    onClick={() =>
      window.open(
        "https://github.com/AbhijayNair/Gait-Analysis-for-Person-Identification",
        "_blank"
      )
    }
  >
    <div className="flex flex-col flex-wrap space-y-2">
      ...
      <h4 className="text-center text-2xl font-semibold text-gray-400 ">
        Gait Analysis for Person Classification
      </h4>
      <p className="text-left text-sm text-gray-600">
        Developed a groundbreaking model that utilizes gait recognition with a
        92% accuracy rate, overcoming the limitations arising from wearing masks.
      </p>
