    ...
    <section className="" id="about">
      <div className="grid grid-cols-2 sm:grid-cols-12 text-white lg:py-20">
        ...
        <div className="text-left col-span-8 text-white lg:text-xl pt-6">
          ...
          experience in Computer Vision applications involving pose estimation,
          image analysis and classification using the frequency spectrum.
          <br />
          While I continue to honor my skills in deep learning, I&apos;ve always
          had a profound interest in developing frontend applications, primarily
          mobile but I have been delving into web development recently in
          hopes of reaching a larger user base.
        </div>
      </div>
    </section>
  );
