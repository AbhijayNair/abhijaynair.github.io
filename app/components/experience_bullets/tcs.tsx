          ...
          {tcsVisible && (
            <div className="flex flex-col px-2 py-1">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-12 space-x-1 space-y-1 w-fit">
                <div className="text-slate-400 col-span-4 place-self-center border border-slate-500 rounded-3xl w-fit py-2 px-4 text-center font-medium hover:bg-secondary hover:text-white">SQL</div>
                <div className="text-slate-400 col-span-4 place-self-center border border-slate-500 rounded-3xl w-fit py-2 px-4 text-center font-medium hover:bg-middle hover:text-black">Git</div>
                <div className="text-slate-400 col-span-4 place-self-center border border-slate-500 rounded-3xl w-fit py-2 px-4 text-center font-medium hover:bg-primary hover:text-black">Excel</div>
              </div>
            </div>
          )}
        </div>
