...
export function ingenid_ft(
  setIngenIdFtVisible: React.Dispatch<React.SetStateAction<boolean>>,
  ingenIdFtVisible: boolean
) {
  return (
    <li
      className="border border-[#33353F] rounded-lg w-full px-4 py-4 bg-[#18191E]"
      onClick={() => setIngenIdFtVisible(!ingenIdFtVisible)}
    >
            ...
            <div className="flex flex-col px-2 py-1">
              ...
              <div className="px-2 py-1 text-slate-300">
                <ul className="list-disc px-4">
                  <li>
                    Leveraged Google Cloud and Firebase Cloud Messaging voice
                    authentication requests to a target user device.
                  </li>
                  <li>
                    Achieved a significant reduction in prototyping sprint for Deep
                    Learning models by utilizing Python and Docker to streamline the CI/CD process.
                  </li>
                </ul>
              </div>
          ...
          <div className="flex flex-row">
            ...
            <div
              className={`transition-all transform ${
                ingenIdFtVisible ? "rotate-180" : "rotate-0"
              }`}
            >
              <svg
